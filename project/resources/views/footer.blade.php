  ...
  <body>
                ...
                <div class="col-12 p-0 bg-green" >
                    <nav class="navbar navbar-expand-lg w-100 m-0 p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link h-100" href="index.html"><i class="fas fa-home h-100"></i></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item dropdown ">
                                    <a class="nav-link dropdown-toggle h-100" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fas fa-user-alt mr-1"></i>All Member 
                                    </a>
            ...
            <div class="row row-2">
                <div class="col-3 m-0 p-0">
                    <ul class="d-flex list">
                        ...
                        <li>
                            <a class="" href="login.html"><i class="fas fa-sign-in-alt"></i>Login</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container container-body1">
            ...
            <div class="row row-post">
                ...
                <div class="col-9 ">
                    <h6 class="title"> <a href="post.html">Bababab babab</a> </h6>
                    <p > Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321Forum 21321</p>  
                    <small>View:</small>
